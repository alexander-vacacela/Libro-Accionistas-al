...
export default function Desbloqueo() {
  ...
  const addOperacion = async () => {
    try {
        ...
        setFormData({ fecha: fecha, operacion: 'Desbloqueo', idCedente: '', cedente: '', idCesionario: '', cesionario: '', titulo: '' , acciones: '',  estado: 'Pendiente', usuarioIngreso: '', usuarioAprobador: '', cs: '', cg: '', ci: '', es: '', cp: ''})
